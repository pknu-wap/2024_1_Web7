...
public class TestController {
    ...
    public void addPlace(@RequestParam Map<String, MultipartFile> files) throws IOException {
         ...
         * 애견 카페
         */
        Place place12 = new Place("도그민", 35.1548, 129.1201, allImageLists.get(11), LocalTime.of(11, 0), LocalTime.of(21, 0), "부산광역시 수영구 민락동 179-1번지 6층", "0507-1306-6720", "강아지 없이도 입장가능한 중소형견(~15kg) 애견카페입니다", DogSize.SMALL, PlaceType.CAFE, null);
        ...
        Place place20 = new Place("아껴줄개", 35.192, 129.1, allImageLists.get(19), LocalTime.of(12, 0), LocalTime.of(21, 0), "부산광역시 동래구 온천천로 463", "051-532-2232", "온천천 산책로가 잘 보이는 2층 애견카페입니다. 방문훈련 / 출장강연/ 애견유치원 / 애견호텔 / 어질리티/펫트니스 운영중 ]", DogSize.SMALL, PlaceType.CAFE, null);
        placeRepo.save(place20);

        Place place21 = new Place("덕수네 애견카페", 35.0993, 129.0317, allImageLists.get(20), LocalTime.of(12, 0), LocalTime.of(21, 0), "부산광역시 중구 광복동2가", "051-245-2956", "덕수네애견카페 광복동,남포동,애견카페, DOG CAFE 반려견없이 입장가능![유아동입장가능] 반려견호텔,놀이터,애견유치원", DogSize.SMALL, PlaceType.CAFE, null);
        ...
        Place place36 = new Place("펫스토어", 35.1638, 129.0546, allImageLists.get(35), LocalTime.of(10, 0), LocalTime.of(22, 0), "부산광역시 부산진구 새싹로 76", "051-808-9319", "1층 2층 애견용품 (강아지 고양이)- 사료, 간식, 장난감, 패드  3층 미용,호텔 영업시간 :am10:00~ pm10:00 친절한직원들이 기다리고있습니다.", DogSize.SMALL, PlaceType.GOODS, null);
        placeRepo.save(place36);

        Place place37 = new Place("펫마트 다대점", 35.0601, 128.9809, allImageLists.get(36), LocalTime.of(9, 0), LocalTime.of(22, 0), "부산광역시 사하구 다송로72번길 50", "051-266-1550", "한국프랜차이즈대상 2관왕  반려동물을 위한 모든 것! 강아지-고양이-소동물 국내 반려동물용품 NO.1 프랜차이즈 최대규모/최다품목/최저가격  @주차가능 / 연중무휴 / 반려동물동반가능 / 무료와이파이 @파격적 적립혜택 / 구매사은품 상시 증정! @다양한 묶음할인 제품 / 매월 할인 이벤트 진행 중!  반려동물용품은 역시 펫마트!", DogSize.SMALL, PlaceType.GOODS, null);
        placeRepo.save(place37);

        Place place38 = new Place("핫독(HOT DOG)애견용품", 35.0979, 129.0328, allImageLists.get(37), LocalTime.of(11, 0), LocalTime.of(21, 0), "남포동2가 28-3번지 중구 부산광역시", "051-247-0999", "안녕하세요, 핫독(HOT DOG)애견용품입니다", DogSize.SMALL, PlaceType.GOODS, null);
        placeRepo.save(place38);

        Place place39 = new Place("애견용품", 35.1568, 128.9776, allImageLists.get(38), LocalTime.of(10, 0), LocalTime.of(21, 0), "감전동 128-1번지 사상구 부산광역시", "051-323-6664", "안녕하세요, 애견용품입니다", DogSize.SMALL, PlaceType.GOODS, null);
        placeRepo.save(place39);

        Place place40 = new Place("펫존애완용품할인매장", 35.0856, 128.9857, allImageLists.get(39), LocalTime.of(10, 0), LocalTime.of(20, 30), "부산 사하구 을숙도대로 741 영생비치맨션", "051-996-9631", "안녕하세요, 펫존애완용품할인매장입니다", DogSize.SMALL, PlaceType.GOODS, null);
